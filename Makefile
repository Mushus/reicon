...
build:
	...
	GOARTCH=arm GOOS=linux GOARM=6 go build -o ./build/linux-arm6/reicon reicon.go
	GOARTCH=arm GOOS=linux GOARM=7 go build -o ./build/linux-arm7/reicon reicon.go
